...
- Audible smoke test: feed a 440 Hz sine to the sink, hear a tone for 1 second on `termkrush --test-tone`.

## Acceptance

- [ ] `termkrush --test-tone` produces an audible 440 Hz sine on default output.
